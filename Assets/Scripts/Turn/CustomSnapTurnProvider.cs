...
namespace UnityEngine.XR.Interaction.Toolkit.Locomotion.Turning
{
    ...
    [AddComponentMenu("XR/Locomotion/Custom Snap Turn Provider", 11)]
    [HelpURL("https://docs.unity3d.com/Manual/xr-snap-turn-provider.html")]
    public class CustomSnapTurnProvider : LocomotionProvider
    {
        ...
        protected void Update()
        {
            ...
            if (locomotionState == LocomotionState.Moving && math.abs(m_CurrentTurnAmount) > 0f)
            {
                ...
                onSnapTurn?.Invoke(m_CurrentTurnAmount);
